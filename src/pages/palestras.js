...
export default function Palestras() {
    return (
        <section id='palestra' className="flex items-center justify-center w-full min-h-screen text-white flex-col bg-gray-900 p-8 ring-1 rounded-md">
            {/* Header */}
            <div className="text-center mb-6">
                <h1 className="text-4xl font-bold animate-fade-down">Palestra Especial</h1>
                <p className="text-base text-gray-400 mt-2 animate-fade">Não perca esta oportunidade!</p>
            </div>
            ...
            <div className="text-center animate-fade-left">
                ...
                <p className="text-lg">Data: <span className="font-semibold text-purple-400">10 de Junho, 2024</span></p>
                <p className="text-lg">Horário: <span className="font-semibold text-purple-400">14:00</span></p>
                <p className="text-lg">Local: <span className="font-semibold text-purple-400">Auditório da Universidade</span></p>
            </div>
        </section>
    )
}
