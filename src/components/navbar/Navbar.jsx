...
const sectionNames = {
    ...
    aquisicoes: 'Sympla e certificados',
                ...
                <Dialog.Root currentSectionName={currentSection}>
                    ...
                    <Dialog.Portal currentSectionName={currentSection}>
                        <Dialog.Overlay className="inset-0 fixed bg-black/20">
                            <Dialog.Content className="fixed z-50 inset-0 md:inset-auto items-center max-md:top-[45%] lg:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[65vh] backdrop-blur-md bg-zinc-900/45 max-md:rounded-t-3xl lg:rounded-3xl flex flex-col outline-none overflow-hidden">
                                ...
                                <div className="flex text-white font-semibold mt-auto pb-2 w-3/4 lg:w-3/5 mx-auto flex-col space-y-2 bottom-0">
                                    <Link href={'/colaboradores'} className="flex justify-center">
                                        <span className="text-sm">Sobre essse projeto</span>
                                    </Link>
                                </div>
                            </Dialog.Content>
                        </Dialog.Overlay>
